	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12 grid-margin stretch-card"> 
				<div class="card">
					<form action="{{ url('admin/questions/edit/'.$data->id) }}" method="post">
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group">
				                    	...
				                    	<input type="text" name="question" class="form-control" placeholder="Enter question" required value="{{ $data->question }}">
				                  	</div>
				                  	<div class="form-group">
				                    	<label>Sequential</label>
				                    	<input type="number" name="seq" class="form-control" placeholder="Enter sequential" required value="{{ $data->seq }}">
				                  	</div>
								</div>
							</div>
											...
											<div class="col-md-12">
												<div class="row">
													<div class="form-group col-md-7">
								                    	<label>Answer</label>
								                    	<input type="text" name="answer[]" class="form-control" placeholder="Enter answer" required value="{{ $val->answer }}">
								                  	</div>
								                  	<div class="form-group col-md-4">
														<label>Code</label>
														<input type="text" name="code[]" class="form-control" placeholder="Enter code" required value="{{ $val->code }}">
													</div>
